...
const createClaim = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield claim_service_1.ClaimService.createClaimIntoBD(user, req.body);
...
const getClaimByUserId = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.user;
    const result = yield claim_service_1.ClaimService.getClaimByUserFromDB(user);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
